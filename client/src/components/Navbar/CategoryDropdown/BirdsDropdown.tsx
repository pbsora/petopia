...
const BirdsDropdown = () => {
  return (
    <div className="relative z-10 px-6 py-5 w-fit group">
      ...
      <div className="absolute flex flex-col gap-3 px-3 py-3 text-lg duration-200 origin-top scale-0 -translate-x-6 translate-y-1 border dark:border-zinc-300 bg-background group-hover:scale-100 rounded-xl">
