        ...
        <div className="flex items-center justify-center flex-1 gap-3">
          <form className="relative w-[70%] " onSubmit={handleSearch}>
            ...
            <input
              type="text"
              id="input-group-1"
              className="bg-gray-50 border border-gray-500 focus:outline-none text-gray-900 text-base rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 py-4  dark:bg-gray-700 dark:border-zind-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
