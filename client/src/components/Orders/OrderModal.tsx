...
const OrderModal = ({ closeModal, order }: Props) => {
  return (
    <>
      <div className="z-50 flex flex-col gap-8 w-[95vw] lg:w-[85vw] m-auto inset-0 h-[85%] fixed border-2 py-4 px-3 border-zinc-400 shadow-sm dark:border-zinc-300 bg-background dark: rounded-xl duration-200  font-roboto">
