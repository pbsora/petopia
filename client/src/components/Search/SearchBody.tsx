...
const SearchBody = () => {
  ...
  return (
    <>
      <div
        className="grid grid-cols-2 col-span-6 px-3 gap-x-2 gap-y-3 md:grid-cols-4 md:gap-4"
        ref={animate}
      >
        <h1 className="col-span-2 pl-2 mb-6 text-xl font-semibold text-zinc-500 dark:text-zinc-300 lg:col-span-4">
